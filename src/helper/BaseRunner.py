...
class BaseRunner(object):
    ...
    def parse_runner_args(parser):
        ...
        parser.add_argument('--topk', type=str, default='10,1,2,3,4,5,20,50',
                            help='The number of items recommended to each user.')
        parser.add_argument('--metric', type=str, default='NDCG,HR,AUC,HIT,MRR',
                            help='metrics: NDCG, HR,MRR')
    ...
    def train(self, data_dict: Dict[str, BaseModel.Dataset]) -> NoReturn:
        ...
        try:
            for epoch in range(self.epoch):
                ...
                # Record dev results
                dev_result = self.evaluate(data_dict['dev'], self.topk[:10], self.metrics)
